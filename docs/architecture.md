...
GitHub Actions обновляет воркер после изменений в `worker/` или `scripts/`; правки сайта статусов воркер не перезапускают. При необходимости развёртывание можно запустить вручную.
